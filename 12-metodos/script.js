...
//Método split - dividir um string em um array de strings
...
//Divide a string em um array de números, usando vírgulas como sepadores // verificar depois.
...
const listNumerosTracos = numerosJoin.join("-");
console.log(listNumerosTracos);
